...
| Module | Contents |
|---|---|
| `moving_averages.py` | SMA, EMA, WMA, Wilder, DEMA, TEMA, HMA, VWMA, McGinley Dynamic, KAMA, TRIX, ZLEMA, T3, ALMA, FRAMA, Laguerre, TRIMA, VIDYA, EHMA, PWMA, MAMA/FAMA, Dominant Cycle Period |
| `momentum.py` | RSI, MACD, Stochastic, Williams %R, CCI, ROC, ROCR, MFI, CMF, TSI, Ultimate Oscillator, PPO, CMO, DPO, KST, Coppock, Fisher Transform, SMI, RVI, BOP, QQE, Awesome Oscillator, Accelerator Oscillator, Connors RSI, Q-Stick, Psychological Line, Disparity Index, APO, ASI, PMO, Chande Trend Score, DSS, VW-RSI |
...
| `volume.py` | OBV, OBV Oscillator, VWAP, VWAP Bands, KVO, EOM, PVT, Force Index, NVI, PVI, AD Line, Chaikin Oscillator, Volume Oscillator, RVOL, Volume ROC, TWAP, VZO, MFI_BW, Volume Delta, Session Range |
| `levels.py` | Pivot Points (Floor, Camarilla, Fibonacci, Woodie, Demark), Fibonacci Retracement |
| `patterns.py` | 27 candlestick pattern detectors (single-, two-, three-, and five-bar) incl. Dragonfly Doji, Gravestone Doji, Spinning Top, Marubozu Bullish/Bearish; Heiken-Ashi transformation |

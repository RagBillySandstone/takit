...
def test_ultimate_oscillator(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(polarticks.ultimate_oscillator, ohlcv_100k)
...
def test_donchian_channels(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(polarticks.donchian_channels, ohlcv_100k, 20)


def test_adx(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    """Benchmark: ADX with period 14."""
    benchmark(polarticks.adx, ohlcv_100k, 14)
...
def test_supertrend(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(polarticks.supertrend, ohlcv_100k, 7)
...
def test_parabolic_sar(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(polarticks.parabolic_sar, ohlcv_100k)
...
def test_pivot_camarilla(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(
        polarticks.pivot_points_camarilla,
        ohlcv_100k["high"],
        ohlcv_100k["low"],
        ohlcv_100k["close"],
    )
...
def test_pivot_fibonacci(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(
        polarticks.pivot_points_fibonacci,
        ohlcv_100k["high"],
        ohlcv_100k["low"],
        ohlcv_100k["close"],
    )
...
def test_pivot_woodie(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(
        polarticks.pivot_points_woodie,
        ohlcv_100k["high"],
        ohlcv_100k["low"],
        ohlcv_100k["close"],
    )
...
def test_pivot_demark(benchmark: Any, ohlcv_100k: pl.DataFrame) -> None:
    ...
    benchmark(
        polarticks.pivot_points_demark,
        ohlcv_100k["open"],
        ohlcv_100k["high"],
        ohlcv_100k["low"],
        ohlcv_100k["close"],
...
def test_crossover(benchmark: Any, close_100k: pl.Series) -> None:
    ...
    fast = polarticks.ema(close_100k, 12)
    slow = polarticks.ema(close_100k, 26)
    benchmark(polarticks.crossover, fast, slow)
